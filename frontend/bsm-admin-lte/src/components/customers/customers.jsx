...
export default class Customers extends Component {
    ...
    render() {
            ...
            <div> 
                ...
                <Content><div style={{borderTop:'1px solid rgb(180, 180, 180)'}}/><br/>{this.state.themeChange?
                    ...
                    <Row>
                     ...
                     <InfoBox cols='12 3' color='green' icon='bank'
                    ...
                    <Row>
                    <Box cols="12 5" title="NEW CUSTOMER" icon="edit" type="primary" collapsable solid>
        ...
        {/* /.item */}
                    ...
                    <Row> 
                    <Box cols="12 8" title="LIST OF CUSTOMERS" type="primary" collapsable>
                    ...
                    <Row>
                    <Box cols="12 8" title="CUSTOMERS GRAPH" type="primary" collapsable>
