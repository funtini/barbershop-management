...
//		expenseService.addExpense(e3);
	...
	public void testAddReportTrue() {
		...
		Report result = reportService.getReports().get(0);
	...
	public void testAddReportFalse() {
		 ...
		 */
		int expect = 2;
		int result = reportService.getReports().size();
	...
	public void testLoadSale() {
		...
		assertEquals(reportService.getReports().isEmpty(),true);			//check that report list is empty before adding reports
		...
		assertEquals(reportService.getReports().contains(rep1802),true);	//check that report list cointains report of 2018/02
		assertEquals(reportService.getReports().size(),3);					//check that number of reports have increased to 3
	}
	...
	public void testLoadSaleFirstInMonth() {
		 ...
		 */
		assertEquals(reportService.getReports().isEmpty(),false);
		assertEquals(reportService.getReports().size(),2);				//check that number of reports have increased to 1
		assertEquals(reportService.getReport(YearMonth.of(2018, 2)),rep1802);		//check that can fin a report of 2018/02
